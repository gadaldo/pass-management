...
public class PassController {
	...
	public ResponseEntity<CustomerPassResourceO> getPasses(@PathVariable Long customerId) {
		log.info("Get passes for customer: {}", customerId);

		CustomerPassResourceO passes = passPersistenceService.findByCustomerId(customerId);
